...
public class ThirdPartyPreferencesActivity extends TrackedActionBarActivity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.third_party_preferences, menu);
		return true;
	}
	...
	public static class PreferencesFragment extends PreferenceFragment
		...
		public void onViewCreated(View view, Bundle savedInstanceState) {
			...
			addPreferencesFromResource(R.xml.preferences_third_party);
		}
