...
public abstract class CitymapsHttpGet<D> extends HttpGet
	 ...
	 * @param serverName The name server that will be used to get the URL string and HTTP parameter object.
	 * @param args The arguments that will be used to get the URL string and HTTP parameter object.
	 */
	public CitymapsHttpGet(Context context, String serverName, Object... args) {
		super();
		mContext = context;
		try {
			setURI(URI.create(getUrlString(serverName, args)));
			setParams(getParams(serverName, args));
