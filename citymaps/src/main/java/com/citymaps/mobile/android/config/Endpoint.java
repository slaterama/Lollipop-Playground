...
public class Endpoint {
	...
	public static final int APPEND_STANDARD = APPEND_TIMESTAMP|APPEND_ANDROID_VERSION|APPEND_DEVICE_ID|APPEND_SECRET;
	public static final int APPEND_USER = APPEND_USER_ID|APPEND_CITYMAPS_TOKEN;
	public static final int APPEND_ALL = APPEND_STANDARD|APPEND_USER;
	...
	public static enum Type {
		...
		EXPLORE_FEATURED_DEALS,
		EXPLORE_FEATURED_HERO_ITEMS,
		EXPLORE_FEATURED_MAPPERS,
		PLACE,
		USER,
		USER_LOGIN,
